...
async def _verify_async(args: argparse.Namespace) -> dict:
    ...
    async with async_playwright() as playwright:
        ...
        selection_version_count = await page.locator('[data-live-message-selection-version="v22"]').count()
        record(
            "live-message-selection-version-current",
            selection_version_count == 1,
            "Agent is running the v22 message-selection bundle that preserves manual live-message selection across feed refreshes, renders ready launch proof, and never embeds live preview frames.",
