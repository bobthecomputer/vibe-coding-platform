...
export const IMAGEGEN_LIBRARY_ARTIFACT = {
  ...
  title: "Archived generated image artifact",
  ...
  provider: "Archived Codex image artifact",
  ...
  selected: true,
  rationale: "Archived bitmap artifact that can be reused only when explicitly selected from diagnostics or artifact review.",
};
...
export const DEFAULT_IMAGE_PROJECT = {
  ...
  layers: [
    ...
    },
    {
      ...
      radius: 16,
      promptRole: "secondary composition panel",
    },
  ],
  history: [],
};
