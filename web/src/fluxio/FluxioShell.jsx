...
const FluxioDrawerPanel = lazy(() => import("./FluxioDrawerPanel.jsx"));
        ...
        {showPersistentDrawer ? (
          <aside className={`fluxio-drawer ${activeDrawer ? "open" : ""}`.trim()}>
            ...
            <div className="drawer-content">
              <Suspense fallback={<LazySurfaceFallback label="Loading drawer panel" />}>
                <FluxioDrawerPanel {...drawerPanelProps} />
              </Suspense>
            </div>
          </aside>
        ) : null}
