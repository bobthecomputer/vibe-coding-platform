...
class DesktopUiContractTests(unittest.TestCase):
    ...
    def test_current_shell_mounts_image_and_voice_surfaces(self) -> None:
        ...
        self.assertIn("Generated images will appear here.", image_studio)
        self.assertIn('provider: {', image_state)
        self.assertIn('id: "codex_subscription_gpt_image2"', image_state)
        self.assertIn("history: []", image_state)
        self.assertNotIn("Generated coastal retreat image", image_state)
        self.assertNotIn("/image-studio/generated-coastal-retreat.png", image_state)
        self.assertNotIn("codex_image_playground_live_review_reference_20260511T071327Z", image_state)
