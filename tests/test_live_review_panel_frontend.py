...
class LiveReviewPanelFrontendTests(unittest.TestCase):
    ...
    def test_image_playground_has_mission1_command_workbench_and_self_repair_path(self) -> None:
        ...
        self.assertIn("image_playground_handoff_command", app)
        ...
        self.assertIn("missionGate?.status", app)
        self.assertIn("Budget-aware plan", app)
        self.assertIn("proof or cap", app)
        self.assertIn("routeProbeEnabled", app)
        self.assertIn("allowProviderCliProbe", app)
        self.assertIn("probeExternalRoutes: routeProbeEnabled", app)
        self.assertIn("probeProviderModels: routeProbeEnabled", app)
        self.assertIn("allowProviderCliProbe: routeProbeEnabled && allowProviderCliProbe", app)
        self.assertIn("Probe Hermes/OpenClaw route", app)
        self.assertIn("Allow slow model call", app)
        self.assertIn('data-image-mission-gate={selfRepairProof?.missionGate?.status || "unknown"}', app)
        ...
        self.assertIn("Backend receipt recorded", app)
        self.assertIn("backendReceiptPath", app)
        ...
        self.assertIn(".image-mission-gate", styles)
        self.assertIn(".image-route-probe-toggle", styles)
