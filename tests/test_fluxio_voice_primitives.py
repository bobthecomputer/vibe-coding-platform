...
class FluxioVoicePrimitiveTests(unittest.TestCase):
    ...
    def test_image_studio_request_draft_reports_preview_and_annotation_proof(self) -> None:
        ...
        self.assertFalse(payload["hasRealArtifact"])
        ...
        self.assertGreaterEqual(payload["workflow"]["readyCount"], 4)
        self.assertEqual(payload["workflow"]["handoffState"], "needs_breakdown")
        self.assertIn("Region plan", payload["workflow"]["nextAction"])
        ...
        self.assertEqual(payload["openAiRouteStatus"]["providerId"], "codex_subscription_gpt_image2")
        self.assertEqual(payload["openAiRouteStatus"]["localStatus"], "codex_subscription_pending")
