...
baseSnapshot.providerEcosystem = {
  ...
  sources: [
    { sourceId: 'opencode_models', label: 'OpenCode models', verifiedAt: '2026-06-21' },
    { sourceId: 'openclaw_model_providers', label: 'OpenClaw model providers', verifiedAt: '2026-06-21' },
    { sourceId: 'litellm_providers', label: 'LiteLLM providers', verifiedAt: '2026-06-21' },
  ],
  updatePolicy: {
    mode: 'safe_refresh',
